...
{
    public static class BitFormatterServices
    {
            ...
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] Type type, SerializationControl control)
        {
            ...
            {
                throw new BitSerializationException(SR.Format(SR.Serialization_NonSerType, type.FullName, type.Assembly.FullName));
            }
            ...
            if (parentType != null && parentType != typeof(object))
            {
                ...
                if (parentTypeCount > 0)
                {
                    ...
                    for (int i = 0; i < parentTypeCount; i++)
                    {
                        ...
                        {
                            throw new BitSerializationException(SR.Format(SR.Serialization_NonSerType, parentType.FullName, parentType.Module.Assembly.FullName));
                        }
        ...
        public static void CheckTypeSecurity(Type t, BitTypeFilterLevel securityLevel)
        {
            // nop
        }
