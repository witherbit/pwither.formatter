    ...
    public class ObjectManager
    {
        ...
        private bool GetCompletionInfo(FixupHolder fixup, [NotNullWhen(true)] out ObjectHolder? holder, out object member, bool bThrowIfMissing)
        {
            ...
            if (holder == null || holder.CanObjectValueChange || holder.ObjectValue == null)
            {
                if (bThrowIfMissing)
                {
                    if (holder == null)
                    {
                        throw new BitSerializationException(SR.Format(SR.Serialization_NeverSeen, fixup._id));
                    }
                    if (holder.IsIncompleteObjectReference)
                    {
                        throw new BitSerializationException(SR.Format(SR.Serialization_IORIncomplete, fixup._id));
                    }
                    throw new BitSerializationException(SR.Format(SR.Serialization_ObjectNotSupplied, fixup._id));
                }
                return false;
            }
        ...
        private void FixupSpecialObject(ObjectHolder holder)
        {
            ...
            if (holder.HasSurrogate)
            {
                ...
                if (returnValue != null)
                {
                    ...
                    {
                        throw new BitSerializationException(SR.Format(SR.Serialization_NotCyclicallyReferenceableSurrogate, surrogate.GetType().FullName));
                    }
        ...
        private bool ResolveObjectReference(ObjectHolder holder)
        {
            ...
            try
            {
                do
                {
                    ...
                    {
                        throw new BitSerializationException(SR.Serialization_TooManyReferences);
                    }
        ...
        ** value  -- the data to set into the field.
        ...
        private bool DoValueTypeFixup(FieldInfo? memberToFix, ObjectHolder holder, object? value)
        {
            ...
            {
                BitFormatterServices.SerializationSetValue(memberToFix, fixupObj, value);
            }
        ...
        internal void CompleteObject(ObjectHolder holder, bool bObjectFullyComplete)
        {
            ...
            if (holder.ObjectValue == null)
            {
                throw new BitSerializationException(SR.Format(SR.Serialization_MissingObject, holder._id));
            }
            ...
            if (holder.HasSurrogate || holder.HasISerializable)
            {
                ...
                if (si == null)
                {
                    throw new BitSerializationException(SR.Serialization_InvalidFixupDiscovered);
                }
                ...
                for (int i = 0; i < fixups._count; i++)
                {
                    ...
                    if (GetCompletionInfo(currentFixup, out tempObjectHolder, out fixupInfo, bObjectFullyComplete))
                    {
                        ...
                        if (tempObjectHolder.TypeLoadExceptionReachable)
                        {
                            ...
                            if (holder.Reachable)
                            {
                                throw new BitSerializationException(SR.Format(SR.Serialization_TypeLoadFailure, holder.TypeLoadException!.TypeName));
                            }
                        }
                        ...
                        switch (currentFixup._fixupType)
                        {
                            case FixupHolder.ArrayFixup:
                                ...
                                {
                                    throw new BitSerializationException(SR.Serialization_ValueTypeFixup);
                                }
                                else
                                {
                            ...
                            case FixupHolder.MemberFixup:
                                ...
                                if (tempMember is FieldInfo)
                                {
                                    ...
                                    if (holder.RequiresValueTypeFixup && holder.ValueTypeFixupPerformed)
                                    {
                                        ...
                                        {
                                            throw new BitSerializationException(SR.Serialization_PartialValueTypeFixup);
                                        }
                                    }
                                    else
                                    {
                                        BitFormatterServices.SerializationSetValue(tempMember, holder.ObjectValue, tempObjectHolder.ObjectValue);
                                    }
                                ...
                                {
                                    throw new BitSerializationException(SR.Serialization_UnableToFixup);
                                }
                                break;
                            default:
                                throw new BitSerializationException(SR.Serialization_UnableToFixup);
        ...
        public void RegisterObject(object obj, long objectID, SerializationInfo? info, long idOfContainingObj, MemberInfo? member, int[]? arrayIndex)
        {
            ...
            {
                throw new BitSerializationException(SR.Serialization_UnknownMemberInfo);
            }
            ...
            if (temp.ObjectValue != null)
            {
                throw new BitSerializationException(SR.Serialization_RegisterTwice);
            }
        ...
        internal void CompleteISerializableObject(object obj, SerializationInfo? info, StreamingContext context)
        {
            ...
            {
                throw new BitSerializationException(SR.Format(SR.Serialization_ConstructorNotFound, t), e);
            }
           ...
           [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.NonPublicConstructors)] Type t)
        {
            ...
            throw new BitSerializationException(SR.Format(SR.Serialization_ConstructorNotFound, t.FullName));
        }
        ...
        public virtual void DoFixups()
        {
            ...
            while (fixupCount != 0)
            {
                ...
                while (fixupObjectsEnum.MoveNext())
                {
                    ...
                    if (temp.ObjectValue == null)
                    {
                        throw new BitSerializationException(SR.Format(SR.Serialization_ObjectNotSupplied, temp._id));
                    }
                    if (temp.TotalDependentObjects == 0)
                    {
            ...
            if (_fixupCount == 0)
            {
                ...
                {
                    throw new BitSerializationException(SR.Format(SR.Serialization_TypeLoadFailure, ((TypeLoadExceptionHolder)TopObject).TypeName));
                }
                return;
            }
            ...
            throw new BitSerializationException(SR.Serialization_IncorrectNumberOfFixups);
        }
        ...
        private void RegisterFixup(FixupHolder fixup, long objectToBeFixed, long objectRequired)
        {
            ...
            {
                throw new BitSerializationException(SR.Serialization_InvalidFixupType);
            }
        ...
        public virtual void RecordFixup(long objectToBeFixed, MemberInfo member, long objectRequired)
        {
            ...
            {
                throw new BitSerializationException(SR.Format(SR.Serialization_InvalidType, member.GetType()));
            }
    ...
    internal sealed class ObjectHolder
    {
            ...
            long idOfContainingObj, FieldInfo? field, int[]? arrayIndex)
        {
            ...
            if (idOfContainingObj != 0 && ((field != null && field.FieldType.IsValueType) || arrayIndex != null))
            {
                ...
                {
                    throw new BitSerializationException(SR.Serialization_ParentChildIdentical);
                }
