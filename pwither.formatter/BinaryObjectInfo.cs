...
namespace pwither.formatter
{
    ...
    internal sealed class WriteObjectInfo
    {
            ...
            SerializationBinder? binder, SerializationControl control)
        {
            ...
            else if (obj is ISerializable)
            {
                ...
                {
                    throw new BitSerializationException(SR.Format(SR.Serialization_NonSerType, _objectType.FullName, _objectType.Assembly.FullName));
                }
                _si = new SerializationInfo(_objectType, converter);
        ...
        private void InitSiWrite()
        {
            ...
            {
                typeInformation = BitBinaryFormatter.GetTypeInformation(_si.ObjectType);
        ...
        private void InitMemberInfo()
        {
            ...
            if (!_serObjectInfoInit._seenBeforeTable.TryGetValue(_objectType, out _cache!))
            {
                ...
                _cache._memberInfos = BitFormatterServices.GetSerializableMembers(_objectType, _context, _control);
            ...
            if (_obj != null)
            {
                _memberData = BitFormatterServices.GetObjectData(_obj, _cache._memberInfos!);
            }
        ...
        internal void GetMemberInfo(out string[]? outMemberNames, out Type[]? outMemberTypes, out object?[]? outMemberData)
        {
            ...
            if (_isSi && !_isNamed)
            {
                throw new BitSerializationException(SR.Serialization_ISerializableMemberInfo);
            }
        }
    ...
    internal sealed class ReadObjectInfo
    {
        ...
        internal MemberInfo? GetMemberInfo(string? name)
        {
            ...
            if (_isSi)
            {
                throw new BitSerializationException(SR.Format(SR.Serialization_MemberInfo, _objectType + " " + name));
            }

            if (_cache._memberInfos == null)
            {
                throw new BitSerializationException(SR.Format(SR.Serialization_NoMemberInfo, _objectType + " " + name));
            }
        ...
        internal Type? GetType(string name)
        {
            ...
            if (type == null)
            {
                throw new BitSerializationException(SR.Format(SR.Serialization_ISerializableTypes, _objectType + " " + name));
            }
        ...
        internal void PopulateObjectMembers(object obj, object?[]? memberData)
        {
            ...
            {
                Debug.Assert(_cache != null && _cache._memberInfos != null);
                BitFormatterServices.PopulateObjectMembers(obj, _cache._memberInfos, memberData);
            }
        }
        ...
        internal Type[]? GetMemberTypes(string[] inMemberNames, Type? objectType)
        {
            if (_isSi)
            {
                throw new BitSerializationException(SR.Format(SR.Serialization_ISerializableTypes, objectType));
            }
            ...
            for (int i = 0; i < _cache._memberInfos.Length; i++)
            {
                ...
                else
                {
                    ...
                    if (!isFound)
                    {
                        ...
                        {
                            Debug.Assert(_cache._memberNames != null);
                            throw new BitSerializationException(SR.Format(SR.Serialization_MissingMember, _cache._memberNames[i], objectType, typeof(OptionalFieldAttribute).FullName));
                        }
                    }
                }
            }
        ...
        internal Type GetMemberType(MemberInfo objMember)
        {
            ...
            throw new BitSerializationException(SR.Format(SR.Serialization_SerMemberInfo, objMember.GetType()));
        }
    ...
    internal sealed class SerObjectInfoCache
    {
        ...
        {
            TypeInformation typeInformation = BitBinaryFormatter.GetTypeInformation(type);
