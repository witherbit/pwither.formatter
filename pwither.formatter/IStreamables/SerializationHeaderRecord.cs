...
namespace pwither.formatter
{
    ...
    internal sealed class SerializationHeaderRecord : IStreamable
    {
        ...
        internal SerializationHeaderRecord(BitBinaryHeaderEnum binaryHeaderEnum, int topId, int headerId, int majorVersion, int minorVersion)
        {
        ...
        public void Read(BinaryParser input)
        {
            ...
            {
                throw new BitSerializationException(SR.Format(SR.Serialization_InvalidFormat, BitConverter.ToString(headerBytes)));
            }

            // binaryHeaderEnum has already been read
            _binaryHeaderEnum = (BitBinaryHeaderEnum)headerBytes[0];
