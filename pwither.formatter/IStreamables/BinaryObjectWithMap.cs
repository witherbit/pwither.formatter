...
namespace pwither.formatter
{
    internal sealed class BinaryObjectWithMap : IStreamable
    {
        ...
        internal BinaryObjectWithMap(BitBinaryHeaderEnum binaryHeaderEnum)
        {
        ...
        internal void Set(int objectId, string name, int numMembers, string[] memberNames, int assemId)
        {
            ...
            _binaryHeaderEnum = assemId > 0 ?
                BitBinaryHeaderEnum.ObjectWithMapAssemId :
                BitBinaryHeaderEnum.ObjectWithMap;
        }
        ...
        public void Read(BinaryParser input)
        {
            ...
            if (_binaryHeaderEnum == BitBinaryHeaderEnum.ObjectWithMapAssemId)
            {
